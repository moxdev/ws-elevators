...
if ( ! function_exists( 'warfield_sanford_setup' ) ) :
	...
	function warfield_sanford_setup() {
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'warfield_sanford_custom_background_args',
				array(
	...
	if ( is_front_page() ) {
		...
		if ( $the_query->have_posts() ) :
			while ( $the_query->have_posts() ) :
				...
				$slider_testimonial      = get_post_meta( get_the_ID(), 'slider_testimonial', true );
				$slider_testimonial_name = get_post_meta( get_the_ID(), 'slider_testimonial_name', true );
				...
				echo '</span>';
				echo '</a>';
				echo '<span class="slider-testimonial">' . $slider_testimonial . '</span>';
				echo '<span class="slider-testimonial-name">&dash; ' . $slider_testimonial_name . '</span>';
				echo '</div>';
				echo '</div>';
				echo '</li>';
